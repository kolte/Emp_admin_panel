    ...
    this.service
      ...
      .then((response) => {
        if (response.status == 200) {
          ...
          console.log(this.employeePunchInData)
            // this.verticalCalendarOptions.events= [
            //   { title: "Today", date: new Date().toISOString().slice(0, 10) }, // Include only today's date
            //   {
            //     title: "Punch In",
            //     start: new Date().toISOString().slice(0, 10) + "T" + this.employeePunchInData[i].punch_in,
            //     backgroundColor: "green",
            //   },
            //   {
            //     title: "Punch Out",
            //     start: new Date().toISOString().slice(0, 10) + "T" + this.employeePunchInData[i].punch_out,
            //     backgroundColor: "red",
            //   },
            // ]
        }
